...
function renderRowsBuyTheDip(list, start, count) {
    ...
    for (let i = start; i < end; i++) {
        ...
        tr.innerHTML = `
            ...
            <td>${imgUrl ? `<img src="${esc(imgUrl)}" alt="" style="width:32px;height:44px;object-fit:contain;" loading="lazy">` : "\u2014"}</td>
            <td>${name}</td>
            <td>${setCode}</td>
...
function renderRowsBestGrading(list, start, count) {
    ...
    for (let i = start; i < end; i++) {
        ...
        tr.innerHTML = `
            ...
            <td>${imgUrl ? `<img src="${imgUrl}" alt="" style="width:32px;height:44px;object-fit:contain;" loading="lazy">` : "\u2014"}</td>
            <td>${name}</td>
            <td>${setCode}</td>
